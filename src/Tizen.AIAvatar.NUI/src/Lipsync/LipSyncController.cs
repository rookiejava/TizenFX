...
namespace Tizen.AIAvatar
{
    ...
    public class LipSyncController : ILipSyncController, IDisposable
    {
        ...
        public void InitializeMic()
        {
            ...
            audioRecorder.InitializeMic(this, 160);
        }
        ...
        public void EnqueueVowels(byte[] recordBuffer, int sampleRate)
        {
            lipSyncer?.OnRecordBufferChanged(recordBuffer, sampleRate);
        }

        public void PlayLipAnimation()
        {
            lipSyncer?.OnRecodingTick();
        }
    }
}
