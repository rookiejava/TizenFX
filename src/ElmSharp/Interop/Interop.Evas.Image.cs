...
internal static partial class Interop
{
    internal static partial class Evas
    {
        ...
        [DllImport(Libraries.Evas)]
        internal static extern void evas_object_image_colorspace_set(IntPtr obj, int colorSpace);

        [DllImport(Libraries.Evas)]
        internal static extern int evas_object_image_colorspace_get(IntPtr obj);
        ...
        internal delegate void ImagePixelsSetCallback(IntPtr data, IntPtr o);
    }
}