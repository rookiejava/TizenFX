...
namespace Tizen.AIAvatar
{
    internal class AudioRecorder : IDisposable
    {
        ...
        internal void InitializeMic(ILipSyncController lipSyncer, uint recordingTime = 160)
        {
            ...
            this.audioRecdingAction = lipSyncer.PlayLipAnimation;
            this.bufferAction = lipSyncer.EnqueueVowels;
